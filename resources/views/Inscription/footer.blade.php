<footer class="bg-white border-t border-gray-200 mt-12">
    <div class="container mx-auto px-4 md:px-6 py-10">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                <h3 class="text-sm font-semibold text-gray-800 mb-4">Liens rapides</h3>
                <ul class="space-y-2 text-sm">
                    <li><a href="{{ url('/inscription') }}" class="text-gray-600 hover:text-green-600">Accueil</a></li>
                    <li><a href="{{ url('/inscription') }}#about" class="text-gray-600 hover:text-green-600">À propos</a></li>
                    <li><a href="{{ url('/inscription') }}#programme" class="text-gray-600 hover:text-green-600">Programme</a></li>
                    <li><a href="{{ url('/inscription') }}#intervenants" class="text-gray-600 hover:text-green-600">Intervenants</a></li>
                </ul>
            </div>
            ...
            <div>
                <h3 class="text-sm font-semibold text-gray-800 mb-4">Contact</h3>
                <ul class="space-y-2 text-sm text-gray-600">
                    <li class="flex items-start">
                        ...
                        <span>25 Avenue Habib Bourguiba, Tunis 1000, Tunisie</span>
                    </li>
                    <li class="flex items-start">
                        <svg class="h-5 w-5 text-green-600 mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
